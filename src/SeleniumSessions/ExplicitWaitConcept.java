...
//		driver.quit(); // closes all the browsers windows which are open.
	...
	public static void clickOn(WebDriver driver, WebElement locator, int timeout) {
		...
		new WebDriverWait(driver,timeout).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.elementToBeClickable(locator)); // explain this line of code 
		locator.click();
